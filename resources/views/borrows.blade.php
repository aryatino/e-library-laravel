                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <span class="px-2 text-xs font-semibold rounded-full bg-yellow-100 text-black p-1">
                                   {{ $borrow->status }}
                                </span>
                                @elseif ($borrow->status == "dipinjam")
                                 <span class="px-2 text-xs font-semibold rounded-full bg-green-100 text-black p-1">
                                   {{ $borrow->status }}
                                </span>
                                @elseif ($borrow->status == "dikembalikan")
                                  <span class="px-2 text-xs font-semibold rounded-full bg-blue-100 text-black p-1">
                                   {{ $borrow->status }}
                                </span>
                                @elseif ($borrow->status == "ditolak")
                                 <span class="px-2 text-xs font-semibold rounded-full bg-red-200 text-black-800 p-1">
                                   {{ $borrow->status }}
                                </span>
                                @endif
                            </td>
                        ...
                        @else 
                          <tr>
                             <td colspan="7" class="p-4 text-center">Tidak Ada Data Peminjaman</td>
                          </tr>
                        @endif
