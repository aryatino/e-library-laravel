      ...
      <div class="relative overflow-x-auto">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        ...
                        <div class="text-yellow-500 hover:text-yellow-600">
                            <a href="/dashboard/author/{{ $author->slug }}/edit"><i class="fa-sharp fa-solid fa-pen-to-square"></i> Edit</a>
                        </div>
                    </td>
                </tr>
                @endforeach
                @else 
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    <td colspan="6" class="p-4 text-center text-white font-semibold">Tidak Ada Data Penulis</td>
                  </tr>
                @endif
