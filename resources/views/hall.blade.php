...
@section('konten')
    ...
    <div class="max-w-4xl mx-auto mb-18">
        <div class="overflow-hidden rounded-lg shadow-lg max-h-[400px]">
            ...
            @else
            <img src="https://picsum.photos/400/400?random=1" alt="Cover Buku" class="w-full h-96 object-cover">
            @endif
        </div>

        <div class="text-center mt-4">
            <h3 class="text-2xl font-bold">
                <a href="/hall/{{ $books[0]->slug}}" class="text-gray-900 hover:text-blue-500 capitalize">
                    {{ $books[0]->name }}
                </a>
            </h3>
