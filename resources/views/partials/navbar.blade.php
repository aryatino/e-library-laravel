            ...
            <div class="relative ml-3">
                ...
                <div 
                    ...
                    <form action="/logout" method="POST">
                        @csrf
                    <button onclick="return confirm('Apakah anda yakin untuk logout?')" type="submit" class="block px-4 py-2 text-sm text-gray-700 cursor-pointer" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</button>
                    </form>
                </div>
            </div>
            </div>
